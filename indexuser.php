...
if (isset($_SESSION['user_id'])) {
    ...
    $user = $userController->getUserData($_SESSION['user_id']); // Get user data based on session user_id
} else {
    // If not logged in, show sign-up/login options
    ...
    <div id="header">
        <ul class="navButtons">
            ...
            <li class="buildnotes" data-linkto="buildnotes">
                ...
                <p class="buildnotestitle">SignUp</p>
            </li>
        </ul>
        <div class="btnCtn">
            <div class="logo"></div>
...
<!--ghadaaaaaa-->
    ...
    <iframe src="View\FrontOffice\auth\register.php" frameborder="0" height="530px" width="1070px" id="User">
    </iframe>    
